    ...
    public class TablesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Tables != null ? 
                          ...
                          Problem("Entity set 'RestaurantDbContext.Tables'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,TableNumber,ImageUrl")] Table table)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,TableNumber,ImageUrl")] Table table)
        {
            if (id != table.Id)
            {
                return NotFound();
